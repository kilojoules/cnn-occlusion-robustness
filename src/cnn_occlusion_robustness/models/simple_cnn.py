...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes=43, channels=[3, 6, 16], kernel_size=5, fc_features=[120, 84]):
        ...
        self.conv2 = nn.Conv2d(in_channels=channels[1], out_channels=channels[2], kernel_size=kernel_size)
