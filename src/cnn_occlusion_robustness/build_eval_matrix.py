...
def build_matrix(eval_dir: str, output_dir: str):
    ...
    try:
        eval_matrix = df.pivot(index='train_condition', 
                               columns='test_condition', 
                               values='accuracy')
    except Exception as e:
        print("Error pivoting DataFrame. This can happen if you have duplicate "
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Build an evaluation matrix from individual result files.")
