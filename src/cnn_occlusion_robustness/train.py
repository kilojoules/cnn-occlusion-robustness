...
class AugmentedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_np = (image_tensor.permute(1, 2, 0).contiguous().numpy() * 255).astype('uint8')
...
def get_effect(effect_name: str) -> Effect:
    ...
    effects = {
        ...
        # simple “mixed” compositions (rain ◦ dust). Tweak params as you like.
...
def main():
    ...
    parser.add_argument('--train-effect', type=str, required=True, 
