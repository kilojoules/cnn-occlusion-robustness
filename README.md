...
**Activations for the "Light Dust" Model:** This model is more cautious and vigilant. As a result, its activations are weaker and more distributed (more gray than bright white). It's not willing to commit with high confidence to any single feature in the early layers.
